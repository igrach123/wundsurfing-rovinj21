                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-7">
                        ...
                        <p class="text-left stars"><span class="fa fa-star"></span><span class="fa fa-star"></span><span
                                ...
                                class="fa fa-star-half-full"></span></p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-7">
                        <p class="text-left">
                            ...
                            take a ride by a boat (20 min/40 Kuna) to get there. The prices are fair.
                            Highly recommended!
                        </p>
                        <p class="text-left stars"><span class="fa fa-star"></span><span class="fa fa-star"></span><span
                                class="fa fa-star"></span><span class="fa fa-star"></span><span
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-7">
                        <p class="text-left">
                            ...
                            <br>
                            <b> Wonderful and talented instructors! Really hot recommended!</b>
                        </p>
                        <p class="text-left stars"><span class="fa fa-star"></span><span class="fa fa-star"></span><span
                                class="fa fa-star"></span><span class="fa fa-star"></span><span
                                class="fa fa-star"></span></p>
